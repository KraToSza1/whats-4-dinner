...
function normForCompare(s) {
    if (typeof s === 'object') {
        return String(s.name || s).trim().replace(/\s+/g, " ").toLowerCase();
    }
...
const UNITS = [
    ...
    "lb","lbs","pound","pounds","oz","ounce","ounces","g","gram","grams","kg","kilogram","kilograms",
    "ml","milliliter","milliliters","l","liter","liters",
    "pinch","clove","cloves","slice","slices","can","cans","package","packages"
];
const DESCRIPTORS = [
    "boneless","skinless","fresh","ground","dried","chopped","diced","minced","sliced","grated","shredded",
    "to","taste","of","the","and","or","for","about","plus","divided","optional"
];
const ALIASES = [
...
export function normalizeIngredient(raw) {
    ...
    for (const [re, name] of ALIASES) {
        if (re.test(base)) { base = name; break; }
    }
