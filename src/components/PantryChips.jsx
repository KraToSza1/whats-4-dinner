...
const SUGGESTIONS = [
    ...
    "garlic", "potato", "carrot", "bell pepper", "mushroom", "spinach", "lettuce", "avocado", 
    "cucumber", "zucchini", "corn", "peas", "beans", "lentils", "quinoa", "bread", "flour",
    "sugar", "butter", "milk", "yogurt", "cream", "lemon", "lime", "apple", "banana", "strawberry"
];

const CATEGORIES = {
    "Protein": ["chicken", "eggs", "bacon", "tofu", "beans", "lentils"],
    "Vegetables": ["tomato", "broccoli", "onion", "garlic", "potato", "carrot", "bell pepper", "mushroom", "spinach", "lettuce", "avocado", "cucumber", "zucchini", "corn", "peas"],
