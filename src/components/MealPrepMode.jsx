      ...
      >
        ...
        <div className="relative bg-gradient-to-r from-orange-500 to-red-600 p-6 text-white">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-2xl font-bold mb-1">🍱 Meal Prep Mode</h2>
              <p className="text-orange-100 text-sm">{recipe.title}</p>
            </div>
            <motion.button
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          <div className="bg-gradient-to-br from-orange-50 to-red-50 dark:from-orange-900/20 dark:to-red-900/20 rounded-xl p-6 border-2 border-orange-200 dark:border-orange-800">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-white/80 dark:bg-slate-800/80 rounded-lg p-4 border border-orange-200 dark:border-orange-800">
                <div className="grid grid-cols-2 gap-4 text-sm">
                  ...
                  <div>
                    ...
                    <span className="ml-2 font-bold text-slate-900 dark:text-white capitalize">
                      {storageMethod}
                    </span>
                  </div>
                </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
              {[
                ...
                <motion.div
                  ...
                  transition={{ delay: idx * 0.1 }}
                  className="bg-white/80 dark:bg-slate-800/80 rounded-lg p-3 border border-emerald-200 dark:border-emerald-800 text-center"
                >
