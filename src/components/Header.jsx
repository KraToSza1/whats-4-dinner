                            ...
                            {showMenu && (
                                <>
                                    ...
                                    <motion.div
                                        ...
                                        className="absolute right-0 mt-2 w-[calc(100vw-2rem)] sm:w-64 md:w-72 bg-white dark:bg-slate-900 rounded-xl shadow-xl border border-slate-200 dark:border-slate-700 py-2 z-50 max-h-[85vh] overflow-y-auto"
                                    >
                                        {/* Account Section */}
                                        <div className="px-3 py-2">
                                            <div className="text-[10px] sm:text-xs font-semibold text-slate-400 dark:text-slate-500 uppercase tracking-wider px-2 mb-2">
                                                Account
                                            </div>
                                            
                                            {userEmail ? (
                                                <>
                                                    <div className="px-3 py-2 mb-2 rounded-lg bg-slate-50 dark:bg-slate-800/50">
                                                    ...
                                                    <button
                                                        ...
                                                        className="w-full px-3 py-2.5 text-left text-sm hover:bg-slate-50 dark:hover:bg-slate-800 rounded-lg flex items-center gap-3 transition-colors mb-1"
                                                    >
                                                    ...
                                                    <button
                                                        ...
                                                        className="w-full px-3 py-2.5 text-left text-sm hover:bg-red-50 dark:hover:bg-red-900/20 rounded-lg flex items-center gap-3 transition-colors"
                                                    >
                                                ...
                                                <button
                                                    ...
                                                    className="w-full px-3 py-2.5 text-left text-sm hover:bg-emerald-50 dark:hover:bg-emerald-900/20 rounded-lg flex items-center gap-3 transition-colors bg-gradient-to-r from-emerald-50 to-teal-50 dark:from-emerald-900/10 dark:to-teal-900/10"
                                                >
                                                    <svg className="w-5 h-5 text-emerald-600 dark:text-emerald-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
                                                    </svg>
                                                    <span className="font-semibold text-emerald-600 dark:text-emerald-400">Sign In / Sign Up</span>
                                                </button>
                                            )}
                                        </div>
                                        ...
                                        <div className="px-3 py-2">
                                            ...
                                            <div className="px-3 py-2 mb-2 rounded-lg bg-slate-50 dark:bg-slate-800/50">
                                                <div className="flex items-center justify-between">
                                                    ...
                                                    <span className={`text-sm font-bold ${isFree ? "text-amber-500" : "text-emerald-500"}`}>
                                                        {planName}
                                                    </span>
                                                </div>
                                            </div>
                                            ...
                                            <button
                                                ...
                                                className={`w-full px-3 py-2.5 text-left text-sm hover:bg-gradient-to-r hover:from-emerald-50 hover:to-teal-50 dark:hover:from-emerald-900/20 dark:hover:to-teal-900/20 rounded-lg flex items-center gap-3 transition-all ${
                                                    isFree ? "bg-gradient-to-r from-emerald-50 to-teal-50 dark:from-emerald-900/10 dark:to-teal-900/10 font-semibold" : ""
                                                }`}
                                            >
                                        ...
                                        <div className="px-3 py-2">
                                            ...
                                            <button
                                                ...
                                                className="w-full px-3 py-2.5 text-left text-sm hover:bg-purple-50 dark:hover:bg-purple-900/20 rounded-lg flex items-center gap-3 transition-all mb-1"
                                            >
                                            ...
                                            <button
                                                ...
                                                className="w-full px-3 py-2.5 text-left text-sm hover:bg-pink-50 dark:hover:bg-pink-900/20 rounded-lg flex items-center gap-3 transition-all mb-1"
                                            >
                                            ...
                                            <button
                                                ...
                                                className="w-full px-3 py-2.5 text-left text-sm hover:bg-blue-50 dark:hover:bg-blue-900/20 rounded-lg flex items-center gap-3 transition-all"
                                            >
                                        ...
                                        <div className="px-3 py-2">
                                            ...
                                            <button
                                                ...
                                                className="w-full px-3 py-2.5 text-left text-sm hover:bg-blue-50 dark:hover:bg-blue-900/20 rounded-lg flex items-center gap-3 transition-colors mb-1"
                                            >
                                                <svg className="w-5 h-5 text-blue-600 dark:text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            ...
                                            <label className="w-full px-3 py-2.5 text-left text-sm hover:bg-green-50 dark:hover:bg-green-900/20 rounded-lg flex items-center gap-3 cursor-pointer transition-colors">
                                        ...
                                        <div className="px-3 py-2">
                                            ...
                                            <button
                                                ...
                                                className="w-full px-3 py-2.5 text-left text-sm hover:bg-slate-50 dark:hover:bg-slate-800 rounded-lg flex items-center gap-3 justify-between transition-colors mb-1"
                                            >
                                        ...
                                        <div className="px-3 py-2">
                                            ...
                                            >
                                                ...
                                                <span className="font-medium text-xs">Terms of Service</span>
                                            </button>
                                            ...
                                            <button
                                                ...
                                                className="w-full px-3 py-2.5 text-left text-sm hover:bg-slate-50 dark:hover:bg-slate-800 rounded-lg flex items-center gap-3 transition-colors"
                                            >
                                                <svg className="w-5 h-5 text-slate-600 dark:text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
                                                </svg>
