...
export function RecipeCardSkeleton() {
    return (
        <div className="rounded-xl overflow-hidden bg-slate-100 dark:bg-slate-800 shadow-sm animate-pulse">
            ...
            <section className="relative py-10">
                <div className="mx-auto max-w-4xl px-4 sm:px-6">
                    ...
                    <div className="flex flex-wrap gap-2 justify-center mb-6">
                        {[1, 2, 3, 4].map((i) => (
                            <div key={i} className="h-10 w-20 bg-slate-200 dark:bg-slate-800 rounded animate-pulse" />
                        ))}
                    </div>
