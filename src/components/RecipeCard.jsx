...
const RecipeCard = ({ recipe, onFavorite, isFavorite }) => {
  ...
  // Pass the recipe via router state so the detail page can render immediately
  const handleCardClick = () => navigate(`/recipe/${recipe.id}`, { state: { recipe } });
  ...
  return (
    ...
    >
      <div className="relative">
        ...
        >
          <span aria-hidden className={isFavorite ? "text-rose-500" : "text-slate-500"}>❤</span>
        </button>
      </div>
