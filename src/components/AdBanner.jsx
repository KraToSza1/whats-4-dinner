...
export function InlineAd({ className = "" }) {
    ...
    return (
        <div className={`bg-gradient-to-r from-blue-50 to-purple-50 dark:from-slate-800 dark:to-slate-900 rounded-lg sm:rounded-xl p-3 sm:p-4 border border-blue-200 dark:border-blue-800 ${className}`}>
