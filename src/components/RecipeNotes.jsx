  ...
  return (
    <>
      <motion.button
        ...
        type="button"
        className={`px-2.5 sm:px-3 py-2 sm:py-1.5 rounded-lg text-xs sm:text-sm font-medium flex items-center gap-1.5 sm:gap-2 min-h-[44px] sm:min-h-0 touch-manipulation flex-shrink-0 transition-all ${
          hasNotes
      ...
      >
        ...
        {noteCount > 0 && (
          <span className="bg-white/20 dark:bg-white/10 px-1.5 py-0.5 rounded-full text-xs font-bold">
            {noteCount}
          </span>
        )}
      </motion.button>
